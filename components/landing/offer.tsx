    ...
    <section id="offerta" className="border-y border-line bg-white py-[120px]">
      <div className="mx-auto max-w-[1120px] px-6">
        <div className="mb-14 max-w-2xl">
          ...
          <p className="max-w-[46ch] text-muted">{section.intro[lang]}</p>
        </div>
          ...
          {tracks.map((track) => {
            ...
            return (
              <RevealItem
                ...
                className={
                  featured
                    ? "card-hover relative flex flex-col rounded-xl border-2 border-accent bg-accent/[0.04] p-7 md:-translate-y-2"
