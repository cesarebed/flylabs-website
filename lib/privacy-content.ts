...
export const privacy = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        {
          it: "Per erogare il servizio ci avvaliamo di fornitori terzi che agiscono come responsabili del trattamento ai sensi dell'art. 28 GDPR: Vercel Inc. (hosting del sito e statistiche cookieless Web Analytics/Speed Insights), Sanity (sistema di gestione dei contenuti), Resend (invio delle email generate dal form), la piattaforma dell'assistente (gpt-trainer, tramite gptchatbot.it, che per generare le risposte usa un modello linguistico di Google) e, ove attivato, Google (Google Analytics 4).",
          en: "To deliver the service we rely on third-party providers acting as processors under art. 28 GDPR: Vercel Inc. (site hosting and cookieless Web Analytics/Speed Insights), Sanity (content management system), Resend (sending emails generated by the form), the assistant platform (gpt-trainer, via gptchatbot.it, which uses a Google language model to generate answers) and, where activated, Google (Google Analytics 4).",
        },
        {
    ...
    },
    {
      ...
      body: [
        {
          it: "Alcuni fornitori (ad esempio Vercel, Resend, Google e gpt-trainer) possono trattare dati negli Stati Uniti. In tal caso il trasferimento avviene sulla base di garanzie adeguate: clausole contrattuali standard (SCC) e/o certificazione EU-US Data Privacy Framework. Puoi richiederci copia delle garanzie adottate scrivendo a info@flylabs.ai.",
          en: "Some providers (for example Vercel, Resend, Google and gpt-trainer) may process data in the United States. In that case the transfer is based on appropriate safeguards: standard contractual clauses (SCC) and/or EU-US Data Privacy Framework certification. You can request a copy of the safeguards by writing to info@flylabs.ai.",
        },
      ],
    },
    {
      ...
      body: [
        {
          it: "L'assistente è fornito da gpt-trainer (Stati Uniti, tramite gptchatbot.it) e si attiva solo quando lo apri. Il testo che inserisci viene inviato a un modello linguistico che genera la risposta, oggi un modello Gemini di Google richiamato dalla piattaforma del fornitore; questi fornitori possono operare fuori dall'Unione Europea, con le garanzie indicate sopra. Le conversazioni possono costituire dati personali: ti invitiamo a non inserire dati particolari (art. 9 GDPR) o riservati, né dati di terzi. La conservazione delle conversazioni segue le impostazioni della piattaforma del fornitore.",
          en: "The assistant is provided by gpt-trainer (United States, via gptchatbot.it) and activates only when you open it. The text you enter is sent to a language model that generates the answer, currently a Google Gemini model called by the provider's platform; these providers may operate outside the European Union, under the safeguards indicated above. Conversations may constitute personal data: please do not enter special-category data (art. 9 GDPR), confidential data, or third parties' data. Retention of conversations follows the provider platform's settings.",
        },
      ],
    },
    {
      ...
      body: [
        {
          it: "Dati del form/richieste non trasformate in un rapporto: fino a 24 mesi. Dati contrattuali, contabili e fiscali: 10 anni (art. 2220 c.c. e normativa fiscale). Log tecnici della piattaforma di hosting (Vercel): al massimo 30 giorni, oggi 1 ora. Conversazioni con l'assistente: secondo la retention del fornitore. Scelte sui cookie: fino a 6 mesi, oltre le quali il consenso viene richiesto di nuovo.",
          en: "Form/request data not turned into a relationship: up to 24 months. Contractual, accounting and tax data: 10 years (art. 2220 of the Italian Civil Code and tax law). Hosting platform technical logs (Vercel): 30 days at most, currently 1 hour. Assistant conversations: per the provider's retention. Cookie choices: up to 6 months, after which consent is requested again.",
        },
      ],
    },
    {
