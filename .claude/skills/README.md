# Skill di questo repo

Claude Code le trova da solo (frontmatter `description` di ogni `SKILL.md`), questo file è solo per orientarsi a occhio. Aggiorna la riga quando aggiungi/rinomini una skill.

| Skill | Quando |
|---|---|
| [`cms-change`](cms-change/SKILL.md) | Nuova sezione, nuovo tipo di documento o nuovi campi nel content model Sanity |
